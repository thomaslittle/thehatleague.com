...
export const Route = createFileRoute("/rules")({
  component: RulesPage,
  head: () => ({
    meta: ogMeta({ title: "Rules · The Hat League", description: "The Hat League rules — Season 3 archive, with Season 4 updates landing soon.", dynamic: true }),
  }),
});
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-[1320px] px-6 pt-16 pb-12 md:px-10 md:pt-24 md:pb-16">
            <div className="text-xs font-bold tracking-[0.28em] text-thl-orange uppercase">
              Rules · Season 04 update in progress
            </div>
            <h1 className="mt-4 text-5xl leading-[0.95] font-bold tracking-[-0.045em] text-neutral-900 sm:text-6xl md:text-7xl dark:text-white">
              ...
              <br />
              new wrinkles{" "}
              <span className="font-marker text-thl-orange">coming for S04.</span>
            </h1>
            <p className="mt-6 max-w-2xl text-lg text-neutral-600 md:text-xl dark:text-neutral-400">
              ...
              how things ran. The Season 4 ruleset is being overhauled —
              fields marked &quot;TBA&quot; will fill in as decisions land.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-[1320px] px-6 pb-10 md:px-10">
          <div className="flex items-center gap-3 rounded-2xl border border-thl-orange/30 bg-thl-orange/10 px-5 py-4">
            ...
            <p className="text-sm text-neutral-800 dark:text-neutral-200">
              <span className="font-bold">Season 4 note:</span> these rules
              are changing significantly. Treat everything below as
              placeholder until the new ruleset drops here.
            </p>
          </div>
        </section>
