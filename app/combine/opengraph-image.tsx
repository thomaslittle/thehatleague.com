...
export const alt = "The Hat League — Draft Combine";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flex: 1, flexDirection: "column", justifyContent: "center" }}>
          <div style={{ display: "flex", ...TYPE.display, fontSize: 110 }}>Scout the</div>
          <div style={{ display: "flex", ...TYPE.marker, fontSize: 160, marginTop: -6, color: "#f76103" }}>
            field.
          </div>
        </div>
        <div
        ...
        >
          <span>thehatleague.com/combine</span>
