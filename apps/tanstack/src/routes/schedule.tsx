...
export const Route = createFileRoute("/schedule")({
  ...
  head: () => ({
    meta: ogMeta({ title: "Schedule · The Hat League", description: "The Hat League schedule. Drops once the draft sets the bracket.", dynamic: true }),
  }),
});
          ...
          <div className="mx-auto grid max-w-[1320px] gap-10 px-6 py-16 md:grid-cols-[1fr_auto] md:px-10 md:py-20">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-neutral-600 dark:text-neutral-400">
                When the draft is done, we drop the full schedule (team vs
                team, by week) here. Captain reschedules go through the
