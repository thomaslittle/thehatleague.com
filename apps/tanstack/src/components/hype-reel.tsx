      ...
      <div className="relative mx-auto max-w-[1320px] px-6 py-20 md:px-10 md:py-28">
        <div className="grid items-end gap-6 md:grid-cols-[1fr_auto]">
          <div>
            ...
            <h2 className="mt-3 text-4xl leading-tight font-bold tracking-[-0.02em] md:text-5xl">
              Roll the{" "}
        ...
        <ul className="mt-10 grid gap-6 md:mt-14 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
          {VIDEOS.map((v) => (
            <li key={v.id}>
              <HypeCard video={v} />
            </li>
        ...
        {playing ? (
          ...
          >
            <img
              src={thumbSrc}
              alt=""
              className="absolute inset-0 h-full w-full object-cover transition duration-500 group-hover/play:scale-[1.03]"
            />
            <span
              aria-hidden
